...
public class RankingNormal extends Ranking{
    ...
    /*public static void readFile() {
        ...
        try {
            ...
            archivo = new File ("Minesweeper/src/com/company/RankingNormal.txt");
    ...
    public static void createFile() {
        ...
        PrintWriter pw = null;
        try {
            fichero = new FileWriter("Minesweeper/src/com/company/RankingNormal.txt",true);
